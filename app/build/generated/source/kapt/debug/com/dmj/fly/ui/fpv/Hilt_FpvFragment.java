...
public abstract class Hilt_FpvFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FpvFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FpvFragment_GeneratedInjector) this.generatedComponent()).injectFpvFragment(UnsafeCasts.<FpvFragment>unsafeCast(this));
    }
  }
