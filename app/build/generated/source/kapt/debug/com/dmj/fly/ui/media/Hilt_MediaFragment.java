...
public abstract class Hilt_MediaFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MediaFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MediaFragment_GeneratedInjector) this.generatedComponent()).injectMediaFragment(UnsafeCasts.<MediaFragment>unsafeCast(this));
    }
  }
