...
public abstract class Hilt_TelemetryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TelemetryFragment() {
    super();
  }

  Hilt_TelemetryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TelemetryFragment_GeneratedInjector) this.generatedComponent()).injectTelemetryFragment(UnsafeCasts.<TelemetryFragment>unsafeCast(this));
    }
  }
